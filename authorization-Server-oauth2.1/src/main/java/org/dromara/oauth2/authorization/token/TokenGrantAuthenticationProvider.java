...
@Slf4j
public class TokenGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        TokenGrantAuthenticationToken authenticationToken = (TokenGrantAuthenticationToken) authentication;
     ...
     * @return 认证信息
     */
    public Authentication getAuthenticatedUser(TokenGrantAuthenticationToken authenticationToken) {
        // 获取Token信息
        Map<String, Object> additionalParameters = authenticationToken.getAdditionalParameters();
        String token = (String) authenticationToken.getPrincipal();
        //String Token = (String) additionalParameters.get(SecurityConstants.OAUTH_PARAMETER_NAME_PHONE);
        String Token = (String) additionalParameters.get(OAuth2Constant.AUTHORITIES_TOKEN);
        ...
        //UsernamePasswordAuthenticationToken unauthenticated = UsernamePasswordAuthenticationToken.unauthenticated(Token, Token);

        UsernamePasswordAuthenticationToken unauthenticated = UsernamePasswordAuthenticationToken.authenticated(userDetails,clientPrincipal,userDetails.getAuthorities());
    ...
    public boolean supports(Class<?> authentication) {
        return TokenGrantAuthenticationToken.class.isAssignableFrom(authentication);
    }
